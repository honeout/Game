...
{
    //モデルのロード
    model = new Model("Data/Model/Player/Weapon/shield.mdl");
...
void Shiled::Update(float elapsedTime)
{
    float speed = 10;
    ...
    if(PlayerManager::Instance().GetGuardMode())
...
void Shiled::Render(RenderContext& rc, ModelShader* shader)
{
...
//}
//
//void Shiled::UpdateDual(float elapsedTime)
//{
//    //プレイヤーの位置を常に取得し続ける
//    PlayerManager& playerMgr = PlayerManager::Instance();
//
...
void Shiled::TransitionGread()
{

    //PlayerManager::Instance().SetStartAnimation(false);

    playerPositionGreat = PlayerManager::Instance().
        GetPlayer(PlayerManager::Instance().GetWeapon())->GetPosition();

    playerPositionGreat.y += 2.5f;

    angle = PlayerManager::Instance()
        .GetPlayer(PlayerManager::Instance().GetWeapon())->GetAngle();
    //angle.y = PlayerManager::Instance().
    //    GetPlayer(3)->GetAngle().y;
...
void Shiled::UpdateGread(float elapsedTime)
{
    playerPositionGreat = PlayerManager::Instance().
        GetPlayer(PlayerManager::Instance().GetWeapon())->GetPosition();
...
//}
//
//void Shiled::UpdateGun(float elapsedTime)
//{
//    //プレイヤーの位置を常に取得し続ける
//    PlayerManager& playerMgr = PlayerManager::Instance();
//
